...
contract DoubleEntryPointFactory is Level {
    ...
    event DoubleEntryPointFactory__DebugEvent(address indexed player, string _message);

    function createInstance(address _player) override public payable returns (address) {
        console.log("createInstance", _player);
        emit LevelInstanceCreatedDebug(_player, "createInstance()");
        ...
        emit LevelInstanceCreatedLog(_player, address(newToken));
